...
public class OCR {
    ...
    public OCR(Context context, String language) {
        ...
        String srcFile = "amh.traineddata";
        InputStream inFile = null;

        dstPathDir = Environment.getExternalStorageDirectory().getAbsolutePath() + dstPathDir;
        String dstInitPathDir = Environment.getExternalStorageDirectory().getAbsolutePath() + "/tesseract";
